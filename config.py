...
class Config:
    ...
    def __init__(self, bluesky_handle: Optional[str] = None, bluesky_password: Optional[str] = None):
        ...
        # Timing configuration - default 3–5 minutes (قابلة للتغيير من ENV أو الواجهة)
        ...
        # Storage paths (مجلد /data هو المسموح في Render)
    ...
    def __str__(self) -> str:
        ...
        return (f"Config(handle={self.bluesky_handle}, "
